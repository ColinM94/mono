    ...
    <div onClick={onClick} className={classes(styles.container, className)}>
      ...
      {position === 4 && (
        <div className={styles.characters}>
          <img src={clericImage} loading="lazy" className={styles.clericImage} />
          <img src={percivalImage} loading="lazy" className={styles.percivalImage} />
          <img src={merlinImage} loading="lazy" className={styles.merlinImage} />

          <img src={assassinImage} loading="lazy" className={styles.assassinImage} />
          <img src={morganaImage} loading="lazy" className={styles.morganaImage} />
          <img src={oberonImage} loading="lazy" className={styles.oberonImage} />
        </div>
      )}
    </div>
  );
